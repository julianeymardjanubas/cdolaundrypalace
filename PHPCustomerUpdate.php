...
<body>
    ...
    <div class="buttons_1">
        <button onclick="window.location.href='PHPUser.php'">Customer Input</button>
        <button onclick="window.location.href='PHPCustomerUpdate.php'">Update Transactions</button>
        <p><lable>*Double Click on Desired Transaction Row on Table Below to Populate*</label></p>
    </div>
    <form action='PHPCustomerEngine.php' method='post'>
        <p>
            <label>ID:</label>
            <input type="text" id="cust_id" name="A" placeholder="Not Updatable" preadonly>
        </p>
        <p>
